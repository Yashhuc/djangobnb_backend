...
def properties_list(request):
    ...
    favourites = []
    properties = Property.objects.all() #get properties detail from the database using ORM
    ...
    serializer = PropertiesListSerializer(properties, many=True) #transform complex data to JSON
...
# API view or end point for booking property
@api_view(['POST'])
